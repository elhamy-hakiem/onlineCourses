            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li <?php pageActive("myCourses"); ?>><a href="index.php">My Courses</a></li>
                        <li <?php pageActive("waiting"); ?>><a href="coursesWaiting.php">Waiting Approve</a></li>
                        <li <?php pageActive("courses"); ?>><a href="../courses.php">Courses</a></li>
                        <!-- user login dropdown start-->
                        <li <?php pageActive("myProfile"); ?> class="dropdown" style="padding-bottom: 0;">
