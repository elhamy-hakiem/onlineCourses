            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    <h4 class="pro-d-title">
                        ...
                        <a href="courselessons.php?action=manage&courseid=<?php echo $lessonData[0]['lesson_course'];?>" class=" pull-right">
                    ...
                    <div class="product_meta">
                        ...
                        <span class="tagged_as"><strong>Instructor Name:</strong><a> <?php echo strtoupper($lessonData[0]['user_name']) ;?></a></span>
                    </div>
                    <?php
